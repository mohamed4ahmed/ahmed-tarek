            ...
            <div className="information">
              ...
              <div className="social">
                <a
                  rel="noopener noreferrer"
                  target="__blank"
                  href="mailto:ahmed_tarek640@gmail.com"
                >
                  <div className="icon">
                    <img
              ...
              <div className="social">
                <a
                  rel="noopener noreferrer"
                  target="__blank"
                  href="https://www.messenger.com/t/elenany1/?messaging_source%3Apages%message_shortlink"
              ...
              <div className="social">
                <a
                  rel="noopener noreferrer"
                  target="__blank"
                  href="https://instagram.com/ahmed_tarek640?igshid=YmMyMTA2M2Y="
              ...
              <div className="social">
                <a href="whatsapp://send?text=welcome&phone=+201022426598">
                  <div className="icon">
                    <img
